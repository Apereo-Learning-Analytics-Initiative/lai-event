...
public class Statement {
   ...
   * Required
   */
  @NotNull(message = "verb can't be null")
  private XApiVerb verb;

  /**
   * an Activity, Agent/Group, Sub-Statement, or Statement Reference. It is the
   * "this" part of the Statement, i.e. "I did this" see
  ...
  /**
   * optional field that represents a measured outcome related to the Statement
   * in which it is included see
  ...
  /**
   * provides information about whom or what has asserted that this Statement is
   * true see https://github.com/adlnet/xAPI-Spec/blob/master/xAPI.md#authority
   * 
   * Optional
   */
